"""
Django settings for Gestion_imprimante project.
...
SECRET_KEY = 'django-insecure-xc-!!cf3)gib*aeqfuk4m3^h$@2bnuv&n_3cjui$+=7jc*%iwv'
...
ROOT_URLCONF = 'Gestion_imprimante.urls'
...
WSGI_APPLICATION = 'Gestion_imprimante.wsgi.application'
